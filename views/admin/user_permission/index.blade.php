            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading bg-red">
                        <h3 class="panel-title"><strong>شاشة </strong> الصلاحيات</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 m-b-20">
                                <div class="btn-group">
                                   {{-- <a href="{{url('user_permission/create')}}"  class="btn btn-danger">
                                ...
                                @if($content->count())
                                    <table class="table table-striped table-hover dataTable" id="table-editable">
                                        ...
                                        <tr role="row">
                                            <th>#</th>
                                            <th>
اسم الصلاحية العربية  </th>
                                           <th>  اسم الصلاحية باللغه الانجليزيه</th>
{{--                                           <th>حالة الصلاحية</th>--}}
{{--                                            <th class="text-center">العمليات</th>--}}
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->permissions_name_ar }}</td>
                                            <td>{{ $item->permissions_name_en }}</td>
{{--                                            <td>{{ $item->permissions_is_active==1?"مفعل":"غيرمفعل" }}</td>--}}
{{--                                            <td>{{ $item->cities_en_name }}</td>--}}
{{--                                            <td>{{ $item->citiesCountry ? $item->citiesCountry->country_ar_name : null }}</td>--}}

                                           {{-- <td class="text-center">
                                                <a style="color: white" class="edit btn btn-dark" href="{{ URL::to('user_permission/' . $item->id . '/edit') }}">
                                                    <i class="fa fa-pencil-square-o"></i>تعديل</a>
                                               --}}{{-- <a class="delete btn btn-danger" href="javascript:;"><i class="fa fa-times-circle"></i>
                                                    Remove
                                                </a>--}}{{--
                                                <form style="display: contents" action="{{ url('user_permission', [$item->id]) }}" method="POST">
