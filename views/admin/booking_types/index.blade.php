            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading bg-red">
                        <h3 class="panel-title"><strong>شاشة </strong> انواع الحجز</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 m-b-20">
                                <div class="btn-group">
                                    <a href="{{url('booking_types/create')}}"  class="btn btn-danger">
                                    ...
                                    <table class="table table-striped table-hover dataTable" id="table-editable">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->btype_name }}</td>
											 <td>{{ $item->type_cust_code }}</td>
											<td>{{ $item->created_at }}</td>
                                            <td>{{ $item->updated_at }}</td>
											
                                            <td class="text-center">
                                                <a style="color: white" class="edit btn btn-dark" href="{{ URL::to('booking_types/' . $item->id . '/edit') }}">
                                                    <i class="fa fa-pencil-square-o"></i>تعديل</a>
                                                <form style="display: contents" action="{{ url('booking_types', [$item->id]) }}" method="POST">
