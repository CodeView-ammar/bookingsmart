            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading bg-red">
                        <h3 class="panel-title"><strong>شاشة </strong> الايام</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 m-b-20">
                              <div class="btn-group">
                                    <a href="{{url('sys_days/create')}}"  class="btn btn-danger">
...
<th>تاريخ الاضافة</th>
 ...
 <th class="text-center">العمليات</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->day_name }}</td>
											<td>{{ $item->uday_cust_code }}</td>
											<td>{{ $item->created_at }}</td>
                                            <td>{{ $item->updated_at }}</td>

                                           <td class="text-center">
                                                <a class="edit btn btn-dark" href="{{ URL::to('sys_days/' . $item->id . '/edit') }}">
                                                    <i class="fa fa-pencil-square-o"></i>تعديل</a>
                                                
                                                <form style="display: contents" action="{{ url('sys_days', [$item->id]) }}" method="POST">
