            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading bg-red">
                        <h3 class="panel-title"><strong>شاشة </strong> موصفات القاعات</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 m-b-20">
                                <div class="btn-group">
                                    <a href="{{url('hall_specs/create')}}"  class="btn btn-danger">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        @php
                                            $print = "
                                            <div class='text-center'>المواصفات</div>
                                             ...
                                             foreach($content as $key=>$item) {
                                                 $print .= "
                                                     <tr>
                                                         ...
                                                         <td>". $item->hallspecsHallCode->hall_code  ."</td>
                                                         <td>". $item->hallspecsSpecsid->specs_name_ar ."</td>
                                                         <td>".  $item->hallspecs_specs_no ."</td>
                                        ...
                                        @endphp
                                        <li><a id="" href="{{ url('pdf') }}?print={{ urlencode($print) }}&name=l,الموصفات.pdf">احفظ كملف pdf</a></li>                                        </li>
                                        </li>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 table-responsive table-red">
                                @if($content->count())
                                    <table class="table table-striped table-hover dataTable" id="table-editable">
                                        ...
                                        <tr>
                                            <td width="35">{{ $key+1  }}</td>
                                            <td>{{ $item->hallspecsHallCode ? $item->hallspecsHallCode->hall_code : null }}</td>
                                            <td>{{ $item->hallspecsSpecsid ? $item->hallspecsSpecsid->specs_name_ar : null }}</td>
                                            <td>{{ $item->hallspecs_specs_no }}</td>

                                            <td class="text-center">
                                                <a style="color: white" class="edit btn btn-dark" href="{{ URL::to('hall_specs/' . $item->id . '/edit') }}">
                                                    <i class="fa fa-pencil-square-o"></i>تعديل</a>
                                                <form style="display: contents" action="{{ url('hall_specs', [$item->id]) }}" method="POST">
