            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading bg-red">
                        <h3 class="panel-title"><strong>تعديل مبني</strong></h3>
                    </div>
                    <div class="panel-body">
                        <form action="{{url('buildings', [$content->id])}}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    @include('.forms.inputText', ['label' => 'رقم المبني', 'name' => 'build_no','content' => $content])
{{--                                    @include('.forms.selectOption', ['label' => ' الحي', 'name' => 'build_dist_id','disName'=>'district_name_ar', 'options' => district::get(),'content' => $content])--}}
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="build_dist_id" id="distSelect" class="form-control">
                                                <option value="{{ $content->build_dist_id }}">{{ $content->buildDist ? $content->buildDist->district_name_ar : null }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    @include('.forms.inputText', ['label' => 'رابط خريطة الموقع', 'name' => 'build_location'])
                                    <div id="map"></div>
