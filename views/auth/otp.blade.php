    ...
    <div class="col-sm-6 col-md-6 col-sm-offset-3 col-md-offset-4">
        <div class="login-box clearfix animated flipInY" style="background-color: white; border: 2px solid darkgreen; border-radius:30px;">
            ...
            <div class="login-logo">
                <b style="color:black">
                  تم إرسال رمز OTP على الايميل
                إلى المستخدم {{$username}}</b>
            ...
            <div class="login-form">
                ...
                <form method="POST" action="{{ route('otp') }}">
                    @csrf
                     ...
                     <input id="username" type="text" style="display: contents;" placeholder="username" class="input-field form-control user @error('username') is-invalid @enderror" name="username" value="{{$username}}" required  autofocus style="border-radius: 10px;border: 2px solid darkgreen;"/>
                     <input id="OTP" type="text" placeholder="otp" class="input-field form-control user @error('OTP') is-invalid @enderror" name="OTP" value="{{ old('OTP') }}" required  autofocus style="border-radius: 10px;border: 2px solid darkgreen;"/>
                    @error('otp')
